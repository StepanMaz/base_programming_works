    ...
    public partial class Documents : Page
    {
        ...
        public Documents(int clientId)
        {
            ...
            var passportsettings = new DatePickerTableSettings
            {
                ...
                {
                    (new TableLink(TourConstituents.GetDict("PassportId", "Data", "Passport", true), "PassportId"), 1),
                    (new TableLink(TourConstituents.GetDict("CountryId", "NameUa", "Country", true), "CountryId"), 5)
                }
            };
